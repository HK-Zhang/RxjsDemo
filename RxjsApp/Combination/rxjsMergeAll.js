...
class MergeAllPoc {
    ...
    func1() {
        ...
        const mapPromise = operators_1.map((val) => myPromise(val));
        const example = source.pipe(mapPromise, operators_1.mergeAll());
        /*
          output:
          "Result: 1"
          "Result: 2"
    ...
    func2() {
        ...
        const interval2$ = rxjs_1.interval(500).pipe(operators_1.take(5));
        /*
