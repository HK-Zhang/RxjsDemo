...
let createInnerObservable = (id) => Rx.Observable.create(observer => {
...
class SwithMapPoc {
    ...
    func3() {
        ...
        const example = source.switchMap(() => Rx.Observable.interval(2000), (outerValue, innerValue, outerIndex, innerIndex) => ({
            outerValue,
            innerValue,
            outerIndex,
            innerIndex
